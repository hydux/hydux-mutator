...
declare namespace Parsimmon {
  ...
  function seq(...parsers: Array<Parser<any>>): Parser<any[]>
	...
	/**
	 * Similar to Parsimmon.seq(...parsers), but yields an object of results named based on arguments. Takes one or more arguments, where each argument is either a parser or a named parser pair ([stringKey, parser]). Requires at least one named parser. All named parser keys must be unique.
	 */
  type SeqObjParser<T> = Parser<T> | [string, Parser<T>]
  function seqObj<T>(p1: SeqObjParser<T>): Parser<[T]>
  function seqObj<T, U>(p1: SeqObjParser<T>, p2: SeqObjParser<U>): Parser<[T, U]>
  function seqObj<T, U, V>(p1: SeqObjParser<T>, p2: SeqObjParser<U>, p3: SeqObjParser<V>): Parser<[T, U, V]>
  function seqObj<T, U, V, W>(p1: SeqObjParser<T>, p2: SeqObjParser<U>, p3: SeqObjParser<V>, p4: SeqObjParser<W>): Parser<[T, U, V, W]>
  function seqObj<T, U, V, W, X>(p1: SeqObjParser<T>, p2: SeqObjParser<U>, p3: SeqObjParser<V>, p4: SeqObjParser<W>, p5: SeqObjParser<X>): Parser<[T, U, V, W, X]>
  function seqObj<T, U, V, W, X, Y>(p1: SeqObjParser<T>, p2: SeqObjParser<U>, p3: SeqObjParser<V>, p4: SeqObjParser<W>, p5: Parser<X>, p6: SeqObjParser<Y>): Parser<[T, U, V, W, X, Y]>
  function seqObj<T, U, V, W, X, Y, Z>(p1: SeqObjParser<T>, p2: SeqObjParser<U>, p3: SeqObjParser<V>, p4: SeqObjParser<W>, p5: SeqObjParser<X>, p6: SeqObjParser<Y>, p7: SeqObjParser<Z>): Parser<[T, U, V, W, X, Y, Z]>
  function seqObj<T>(...parsers: Array<SeqObjParser<T>>): Parser<T[]>
  function seqObj(...parsers: Array<SeqObjParser<any>>): Parser<any[]>
	 ...
	 */
  function formatError<T>(str: string, error: Result<T>): string
  ...
  const optWhitespace: Parser<string>
	 ...
	 */
  const any: Parser<string> // tslint:disable-line
	/**
